      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="my-5 px-8 py-9 text-center text-white sm:px-0">
            ...
            <p className="py-1 text-[1rem] font-normal md:py-2 md:text-font20">
...
function CaseBox() {
  return (
    <div className="mx-8 my-12 grid grid-cols-1 gap-10 md:mx-[5rem] md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
      <div className="group z-10 rounded-lg border p-7 transition-all duration-200 hover:bg-navBtn">
        ...
        <p className="text-font20 font-normal leading-snug text-midBlack group-hover:text-white md:leading-9">
