...
function AboutUs() {
  return (
    <div className="grid grid-cols-1 gap-4 bg-navBtn object-cover md:grid-cols-1 lg:grid-cols-2">
      <div className="p-4 px-8 md:mr-1 md:mt-16 md:p-0 md:pl-regular lg:w-[619px] xl:my-20">
        <h1 className="text-font24 font-bold text-white md:text-font32">
          About Us
        </h1>
        <p className="my-2 text-lg font-normal text-white md:my-3 md:text-lg lg:text-font20 lg:leading-9">
        ...
        <button className="mt-2 w-[130px] whitespace-nowrap rounded-lg border-2 bg-navBtn py-3 text-center text-font20 font-medium text-white transition-all duration-200 hover:border-btnHover hover:bg-btnHover md:mt-5 md:px-p20 md:py-p12 lg:w-heroBtnW">
          Learn More
        </button>
      </div>
